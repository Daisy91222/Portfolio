...
**Your answer:** "Glimpse" provides names of columns at the left end, following specific categories each column has. "Head" gives us what exactly in the first several lines where we can show how each line of data is illustrating.
...
**Your answer:** Because there is space within the name and we need backticks to identify it as a whole name instead of separate words.

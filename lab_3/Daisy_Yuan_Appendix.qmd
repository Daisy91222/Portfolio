...
### 5. Creative Visualization: Properties Sold by Census Tract
```{r eda-creative}
#| message: false
#| warning: false
...
```{r save-rds}
# Save all processed objects for use in slides.qmd
# This avoids re-running heavy computations during slides rendering
saveRDS(phl_props_filtered, "data/phl_props_filtered.rds")
saveRDS(phl_nhoods,         "data/phl_nhoods.rds")
